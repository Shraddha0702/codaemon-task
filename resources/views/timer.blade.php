    ...
    <form action="/save" method="get" id="form1">
        <div class="container-fluid bg-info">
            <div class="modal-dialog">
                ...
                @foreach($allque as $allque)
                <a href={{"/next/".$allque->question_id}} class="btn btn-primary" id="about">{{$allque->question_id}}</a>
                @endforeach
                <a href={{"/next/".$allque->question_id}} class="btn btn-primary" id="about">{{$allque->question_id}}</a>
                    @foreach($que as $que)
                    <div class="modal-header">
                        <h3><span class="label label-warning" id="qid">{{$question_id}}</span>  {{$que->question}}</h3>
                    </div>
                    @endforeach
